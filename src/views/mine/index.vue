<template>
  <div class="app-init scroll-box mine-page footer-hack">
    <div class="user-box public-padding">
      <div class="face-book">
        <img
          @click="$router.openPage('/pay')"
          src="http://qiniu.verydog.cn/show.liluo.cc/normal-face.png"
          alt
        />
      </div>
    ...
    <div class="dingdan public-padding p-item" @click="$router.openPage('/pay')">我的订单</div>
